...
AFRAME.registerComponent('menu', {
    ...
    ***/
    ...
    ring2.addEventListener('mouseenter', function () {
      ...
      ring2.addEventListener('click', function () {
        ...
        entityTastiera.setAttribute('scale', {x: 0.7,y: 0.7,z: 1});
    ...
    **/ 
    ...
    ring3.addEventListener('mouseenter', function () {
      ...
      ring3.addEventListener('click', function () {
        ...
        entityColorPicker.setAttribute('scale', {x: 0.7,y: 0.7,z: 1});
   ...
   ***/
    ...
    ring7.addEventListener('click', function () {
        ...
        entitySuono.setAttribute('scale', {x: 0.7,y: 0.7,z: 1});  
    ...
    **/
    ...
    entityColorPicker.setAttribute('scale', { x: 0.7, y: 0.7, z: 1});
    entityColorPicker.setAttribute('position', {x: 0,y: 1,z: 0});}
    else{
    camer1.appendChild(entityColorPicker);
    entityColorPicker.setAttribute('scale', { x: 0.7, y: 0.7, z: 1});
    entityColorPicker.setAttribute('position', {x: 0,y: -1,z: 0});}
    ...
    scene.appendChild(entitySuono);
     entitySuono.setAttribute('position',{x:0, y:1 , z:0});}
    else{
    camer1.appendChild(entitySuono);
    entitySuono.setAttribute('position',{x:0, y:-1 , z:0});}
...
/*  <!-- sfera centrale suono-->
   ...
   imgSuono1.addEventListener('click', function () {
    ...
    entityTastiera.setAttribute('scale', {x: -1,y: -1,z: -1});
     if(questa.getAttribute('menu').positioning_scene ){
      ...
      entityTastiera.setAttribute('position', {x: 0,y:1 ,z: 0});}
    else{
      camer1.appendChild(entityTastiera);
      entityTastiera.setAttribute('position', {x: 0,y: -1,z: 0});}
    ...
    ***/
    ...
    ringZero.addEventListener('click', function () {
        var testo0=document.querySelector('#testo');
        var valore = testo0.getAttribute('value');
        testo0.setAttribute('value', valore + '0');
      });   
    ...
    ringUno.addEventListener('click', function () {
        var testo1=document.querySelector('#testo');
        var valore = testo1.getAttribute('value');
        testo1.setAttribute('value', valore + '1');
      });   
   ...
   **/
    ...
    ringDue.addEventListener('click', function () {
        var testo2=document.querySelector('#testo');
        var valore = testo2.getAttribute('value');
        testo2 .setAttribute('value', valore + '2');
      });   
    ...
    **/
    ...
    ringTre.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '3');
      });   
    ...
    **/
    ...
    ringQuattro.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '4');
      });   
    ...
    **/
    ...
    ringCinque.addEventListener('mouseenter', function () {
      ...
      ringCinque.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '5');
      });   
    ...
    **/
    ...
    ringSei.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '6');
      });   
    ...
    **/
    ...
    ringSette.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '7');
      });   
    ...
    **/
    ...
    ringOtto.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '8');
      });   
    ...
    **/
    ...
    ringNove.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '9');
      }); 
    ...
    **/
    ...
    ringPunto.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '.');
      }); 
    ...
    **/
    ...
    ringVirgola.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + ',');
      }); 
    ...
    **/
    ...
    ringPuntoVirgola.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + ';');
      }); 
    ...
    **/
    ...
    ringDuepunti.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + ':');
      }); 
    ...
    **/
    ...
    ringTrattobasso.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '_');
      }); 
    ...
    **/
    ...
    ringVirgoletta.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '"');
      }); 
    ...
    **/
    ...
    ringMeno.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '-');
      }); 
    ...
    **/
    ...
    ringPiu.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '+');
      }); 
    ...
    **/
    ...
    ringPer.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '*');
      }); 
    ...
    **/
    ...
    ringDiviso.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '/');
      }); 
    ...
    **/
    ...
    ringBackSlash.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '\\');
      }); 
    ...
    **/
    ...
    ringUguale.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '=');
      }); 
    ...
    **/
    ...
    ringChiocciola.addEventListener('mouseleave', function () {
     ...
     ringChiocciola.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '@');
      }); 
    ...
    **/
    ...
    ringTonda1.addEventListener('mouseleave', function () {
     ...
     ringTonda1.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '(');
      }); 
    ...
    **/
    ...
    ringTonda2.addEventListener('mouseleave', function () {
     ...
     ringTonda2.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + ')');
      }); 
    ...
    **/
    ...
    ringEsclamativo.addEventListener('mouseleave', function () {
     ...
     ringEsclamativo.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '!');
      }); 
    ...
    **/
    ...
    ringPercento.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '%');
      }); 
  ...
  /**@ringECommerciale = contiene il valore & della tastiera
    **/
    ...
    ringECommerciale.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '&');
      }); 
    ...
    **/
    ...
    ringDollaro.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore + '$');
      }); 
...
var A = document.createElement('a-ring');
    ...
    A.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextA.getAttribute('visible')){
        testo .setAttribute('value', valore + 'A');
      }else{
        testo .setAttribute('value', valore + 'a');
        }
      }); 
...
var B = document.createElement('a-ring');
    ...
    B.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextB.getAttribute('visible')){
        testo .setAttribute('value', valore + 'B');
      }else{
        testo .setAttribute('value', valore + 'b');
        }
      }); 
...
var C = document.createElement('a-ring');
    ...
    C.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextC.getAttribute('visible')){
        testo .setAttribute('value', valore + 'C');
      }else{
        testo .setAttribute('value', valore + 'c');
        }
      }); 
...
var D = document.createElement('a-ring');
    ...
    D.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextD.getAttribute('visible')){
        testo .setAttribute('value', valore + 'D');
      }else{
        testo .setAttribute('value', valore + 'd');
        }
      }); 
...
var E = document.createElement('a-ring');
    ...
    E.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextE.getAttribute('visible')){
        testo .setAttribute('value', valore + 'E');
      }else{
        testo .setAttribute('value', valore + 'e');
        }
      }); 
...
var F = document.createElement('a-ring');
    ...
    F.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextF.getAttribute('visible')){
        testo .setAttribute('value', valore + 'F');
      }else{
        testo .setAttribute('value', valore + 'f');
        }
      }); 
...
var G = document.createElement('a-ring');
    ...
    G.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextG.getAttribute('visible')){
        testo .setAttribute('value', valore + 'G');
      }else{
        testo .setAttribute('value', valore + 'g');
        }
      }); 
...
var H = document.createElement('a-ring');
    ...
    H.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextH.getAttribute('visible')){
        testo .setAttribute('value', valore + 'H');
      }else{
        testo .setAttribute('value', valore + 'h');
        }
      }); 
...
var I = document.createElement('a-ring');
    ...
    I.addEventListener('mouseleave', function () {
     ...
     I.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextI.getAttribute('visible')){
        testo .setAttribute('value', valore + 'I');
      }else{
        testo .setAttribute('value', valore + 'i');
        }
      }); 
...
var J = document.createElement('a-ring');
    ...
    J.addEventListener('mouseleave', function () {
     ...
     J.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextJ.getAttribute('visible')){
        testo .setAttribute('value', valore + 'J');
      }else{
        testo .setAttribute('value', valore + 'j');
        }
      }); 
...
var K = document.createElement('a-ring');
    ...
    K.addEventListener('mouseleave', function () {
     ...
     K.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextK.getAttribute('visible')){
        testo .setAttribute('value', valore + 'K');
      }else{
        testo .setAttribute('value', valore + 'k');
        }
      }); 
...
var L = document.createElement('a-ring');
    ...
    L.addEventListener('mouseleave', function () {
     ...
     L.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextL.getAttribute('visible')){
        testo .setAttribute('value', valore + 'L');
      }else{
        testo .setAttribute('value', valore + 'l');
        }
      }); 
...
var M = document.createElement('a-ring');
    ...
    M.addEventListener('mouseleave', function () {
     ...
     M.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextM.getAttribute('visible')){
        testo .setAttribute('value', valore + 'M');
      }else{
        testo .setAttribute('value', valore + 'm');
        }
      }); 
...
var N = document.createElement('a-ring');
    ...
    N.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextN.getAttribute('visible')){
        testo .setAttribute('value', valore + 'N');
      }else{
        testo .setAttribute('value', valore + 'n');
        }
      }); 
...
var O = document.createElement('a-ring');
    ...
    O.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextO.getAttribute('visible')){
        testo .setAttribute('value', valore + 'O');
      }else{
        testo .setAttribute('value', valore + 'o');
        }
      }); 
...
var P = document.createElement('a-ring');
    ...
    P.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextP.getAttribute('visible')){
        testo .setAttribute('value', valore + 'P');
      }else{
        testo .setAttribute('value', valore + 'p');
        }
      }); 
...
var Q = document.createElement('a-ring');
    ...
    Q.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextQ.getAttribute('visible')){
        testo .setAttribute('value', valore + 'Q');
      }else{
        testo .setAttribute('value', valore + 'q');
        }
      }); 
...
var R = document.createElement('a-ring');
    ...
    R.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextR.getAttribute('visible')){
        testo .setAttribute('value', valore + 'R');
      }else{
        testo .setAttribute('value', valore + 'r');
        }
      }); 
...
var S = document.createElement('a-ring');
    ...
    S.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextS.getAttribute('visible')){
        testo .setAttribute('value', valore + 'S');
      }else{
        testo .setAttribute('value', valore + 's');
        }
      }); 
...
var T = document.createElement('a-ring');
    ...
    T.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextT.getAttribute('visible')){
        testo .setAttribute('value', valore + 'T');
      }else{
        testo .setAttribute('value', valore + 't');
        }
      }); 
...
var U = document.createElement('a-ring');
    ...
    U.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextU.getAttribute('visible')){
        testo .setAttribute('value', valore + 'U');
      }else{
        testo .setAttribute('value', valore + 'u');
        }
      }); 
...
var V = document.createElement('a-ring');
    ...
    V.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextV.getAttribute('visible')){
        testo .setAttribute('value', valore + 'V');
      }else{
        testo .setAttribute('value', valore + 'v');
        }
      }); 
...
var W = document.createElement('a-ring');
    ...
    W.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextW.getAttribute('visible')){
        testo .setAttribute('value', valore + 'W');
      }else{
        testo .setAttribute('value', valore + 'w');
        }
      }); 
...
var X = document.createElement('a-ring');
    ...
    X.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextX.getAttribute('visible')){
        testo .setAttribute('value', valore + 'X');
      }else{
        testo .setAttribute('value', valore + 'x');
        }
      }); 
...
var Y = document.createElement('a-ring');
    ...
    Y.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextY.getAttribute('visible')){
        testo .setAttribute('value', valore + 'Y');
      }else{
        testo .setAttribute('value', valore + 'y');
        }
      }); 
...
var Z = document.createElement('a-ring');
    ...
    Z.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
      if(aTextZ.getAttribute('visible')){
        testo .setAttribute('value', valore + 'Z');
      }else{
        testo .setAttribute('value', valore + 'z');
        }
      }); 
    ...
    **/
    ...
    ringDelete.addEventListener('click', function () {
        var testo=document.querySelector('#testo');
        var valore = testo.getAttribute('value');
        testo .setAttribute('value', valore.match(/(.*).$/)[1]);
